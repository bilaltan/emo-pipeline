...
#
#  This script executes all experiment suites required by the Implementation Plan:
#    1. Approach 1 (Primary): Core Partition-Centric GNNs (Phases 0, 1, 2, 3, 3b)
#    2. Approach 2 (Distributed Scale): 2-Hop Feature Propagation (Phases 3.7 & 3.8)
#    3. Ablation Study: Component Impact Matrix (Data for Table 9)
#    4. DistDGL Benchmark: Fair Comparative Evaluation (Data for Table 12)
#    5. Post-Processing: Table LaTeX Export & Figure 8 Plot Rendering
# ══════════════════════════════════════════════════════════════════════════════
...
echo "=========================================================================="
echo " Starting EMO Pipeline Master Experiment Suite"
...
echo "=========================================================================="
echo " ALL EXPERIMENT SUITES COMPLETED SUCCESSFULLY!"
echo " Results Summary Excel: results/run-all_results-7.xlsx"
...
echo " Generated Figure 8 Plot:"
echo "   - PDF: results/figures/fig8_cpu_cores_scaling.pdf"
echo "=========================================================================="
