...
\caption{Performance Comparison on Link Prediction across Base Models and Datasets (including 100M and 1B scale graphs)}
\label{table_lp_main}
\centering
...
\midrule
\textbf{Reddit (100M)} & \textbf{114M edges} & GraphSAGE & \emph{[Pending EMR]} & \emph{[Pending]} & \emph{[Pending EMR]} & \emph{[Pending]} & \emph{[Pending]} \\
\textbf{Reddit (100M)} & \textbf{114M edges} & ARMA & \emph{[Pending EMR]} & \emph{[Pending]} & \emph{[Pending EMR]} & \emph{[Pending]} & \emph{[Pending]} \\
\textbf{Reddit (100M)} & \textbf{114M edges} & ASAP & \emph{[Pending EMR]} & \emph{[Pending]} & \emph{[Pending EMR]} & \emph{[Pending]} & \emph{[Pending]} \\
\midrule
\textbf{Papers100M (1B)} & \textbf{1.6B edges} & GraphSAGE & \emph{[Pending EMR]} & \emph{[Pending]} & \emph{[Pending EMR]} & \emph{[Pending]} & \emph{[Pending]} \\
\textbf{Papers100M (1B)} & \textbf{1.6B edges} & ARMA & \emph{[Pending EMR]} & \emph{[Pending]} & \emph{[Pending EMR]} & \emph{[Pending]} & \emph{[Pending]} \\
\textbf{Papers100M (1B)} & \textbf{1.6B edges} & ASAP & \emph{[Pending EMR]} & \emph{[Pending]} & \emph{[Pending EMR]} & \emph{[Pending]} & \emph{[Pending]} \\
\bottomrule
\end{tabular}
\end{table*}
