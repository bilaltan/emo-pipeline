    ...
    if local_data_dir is not None:
        ...
        if alg:
            ...
            p.update({
                ...
                'p25_nodes':   os.path.join(root, 'phase25_nodes', tag),
                'p25_edges':   os.path.join(root, 'phase25_edges', tag),
                'p25_manifest': os.path.join(root, 'phase25_manifest', tag),
                'p26_nodes':   os.path.join(root, 'phase26_nodes', tag),
                'p26_edges':   os.path.join(root, 'phase26_edges', tag),
                'p26_manifest': os.path.join(root, 'phase26_manifest', tag),
                'p27_manifest': os.path.join(root, 'phase27_manifest', tag),
                'p37_base':    os.path.join(root, 'phase37_propagation', tag),
                'p38_base':    os.path.join(root, 'phase38_classifier', tag),
